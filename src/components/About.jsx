    ...
    <div className='w-full bg-black text-white text-center'>
      <div className=' mx-auto px-4 py-16'>
        <div>
          ...
          <p className='py-4 mb-12 text-xl'>The Defi Protocol system empowers developers, liquidity providers and traders to participate in a financial marketplace that is open and accessible to all.</p>
            <div className='grid sm:grid-cols-2 lg:grid-cols-4 gap-4'>
              ...
              <AboutCard icon={<SiStrapi size={40} />} heading='Seamless connection with any API' text='Build on a flexible framework that can retrieve data from any API, connect with existing systems, and integrate with any current or future blockchain.' />
